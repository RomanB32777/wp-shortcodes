            ...
            <div class="space-shortcode-wrap-ins relative">
                ...
                <div class="space-companies-sidebar-items owl-carousel-items box-100 relative">
                    ...
                    ?>
                        ...
                        <div class="space-companies-sidebar-item <?php if ($columns == 1) { ?>box-100<?php } else if ($columns == 2) { ?>box-50<?php } else if ($columns == 3) { ?>box-33<?php } else { ?>box-25<?php } ?> relative">
