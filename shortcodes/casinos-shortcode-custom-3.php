...
add_shortcode( 'aces-casinos-custom-3', 'aces_casinos_shortcode_custom_3' );

function aces_casinos_shortcode_custom_3( $atts ) {
	...
	if ( $casino_query->have_posts() ) {
		...
		<div class="space-shortcode-wrap space-shortcode-custom-3 relative">
			<div class="space-shortcode-wrap-ins relative">
				...
				<div class="space-companies-sidebar-items owl-carousel-items box-100 relative">
					...
					while ( $casino_query->have_posts() ) :
						...
						} elseif ( get_option( 'casinos_play_now_title' ) ) {
						...
						<div class="space-companies-sidebar-item
						<?php
						if ( $columns == 1 ) {
							?>
							box-100
							...
							?>
												box-25<?php } ?> relative">
							<div class="space-companies-sidebar-item-ins-wrap space-card-hover relative">
									...
									<div class="space-companies-sidebar-item-img left relative">
										...
										if ( wp_get_attachment_image( get_post_thumbnail_id() ) ) {
											...
											<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
												<img src="<?php echo get_the_post_thumbnail_url(); ?>" width="75" height="75" alt="<?php echo $post_title_attr; ?>">
											</a>
										<?php } ?>
								...
								<div class="space-companies-sidebar-item-button relative">
									<a href="<?php echo esc_url( $external_link_url ); ?>" title="<?php echo esc_attr( $button_title ); ?>"
														<?php
														if ( $external_link ) {
															?>
										target="_blank" rel="nofollow" <?php } ?> class="primary-btn"><?php echo esc_html( $button_title ); ?></a>
								</div>
							</div>
						</div>
...
add_action( 'init', 'aces_casinos_shortcode_custom_3' );
