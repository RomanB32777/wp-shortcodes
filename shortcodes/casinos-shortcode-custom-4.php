...
function aces_render_casinos_shortcode_custom_4( $query, $external_link = true, $rating_stars_number = '5' ) {
	...
	while ( $query->have_posts() ) :
		...
		} elseif ( get_option( 'casinos_read_review_title' ) ) {
				...
				<div class="space-organizations-3-archive-item-button box-25 relative">
					<div class="space-organizations-3-archive-item-button-ins box-100 text-center relative">
						<a href="<?php echo esc_url( $external_link_url ); ?>" title="<?php echo esc_attr( $button_title ); ?>"
											...
											if ( $external_link ) {
												?>
							target="_blank" rel="nofollow" <?php } ?> class="primary-btn"><i class="fas fa-check-circle"></i> <?php echo esc_html( $button_title ); ?></a>
